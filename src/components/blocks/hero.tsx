...
export const Hero = () => {
  return (
    <section className="relative">
      <div className="z-10 mx-auto flex max-w-(--breakpoint-xl) flex-col items-center gap-12 px-2 py-12 duration-300 lg:flex-row lg:py-32">
        {/* HERO CONTENT */}
        <div className="bg-background/10 mt-18 h-fit w-full rounded-xl border p-2 backdrop-blur-sm duration-300 sm:p-4 lg:w-auto">
          <Badge
            variant="secondary"
        ...
        {/* CHATBOT */}
        <div className="flex h-[80svh] max-h-[700px] min-h-[500px] w-full flex-col items-center justify-center rounded-xl lg:max-w-[500px]">
          <Chatbot />
        </div>
      </div>
